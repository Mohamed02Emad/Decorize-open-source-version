...
class OrderDetailsModel {
  ...
  factory OrderDetailsModel.fromJson(Map<String, dynamic> json) {
    return OrderDetailsModel(
      ...
      owner: json['user'] != null ? OfferUser.fromJson(json['user']) : null,
  ...
  OrderDetailsModel updateNumberOfApprovedOffers(int numberOfApprovedOffers) {
    return copyWith(acceptedOffersCount: numberOfApprovedOffers);
  }
}
