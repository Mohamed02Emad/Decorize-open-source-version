...
class UserRegisterScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      ...
      child: _UserRegisterScreenBody(),
    );
  }
}

class _UserRegisterScreenBody extends StatefulWidget {
  const _UserRegisterScreenBody();

  @override
  State<_UserRegisterScreenBody> createState() =>
      _UserRegisterScreenBodyState();
}

class _UserRegisterScreenBodyState extends State<_UserRegisterScreenBody> {
