...
class CurrentOffersScreen extends StatelessWidget {
  const CurrentOffersScreen({super.key});

  @override
  Widget build(BuildContext context) {
    return _CurrentOffersScreenBody();
  }
}

class _CurrentOffersScreenBody extends StatelessWidget {
  const _CurrentOffersScreenBody({super.key});
  @override
  Widget build(BuildContext context) {
    return RefreshIndicator.adaptive(
      ...
      child: PaginatedListView(
        ...
        pagingController:
            context.read<GetCurrentOffersCubit>().paginateController,
  ...
  void _refresh(BuildContext context) {
    context.read<GetCurrentOffersCubit>().refresh();
  }
}
