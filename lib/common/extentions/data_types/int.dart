...
extension IntExtention on int {
  ...
  EdgeInsetsDirectional get edgeInsetsStart => EdgeInsetsDirectional.only(start: toDouble());
  EdgeInsetsDirectional get edgeInsetsEnd => EdgeInsetsDirectional.only(end: toDouble());
