...
extension DoubleExtention on double {
  ...
  Widget get gap => SizedBox(height: this , width: this,);
  ...
  EdgeInsetsDirectional get edgeInsetsStart => EdgeInsetsDirectional.only(start: this);
  EdgeInsetsDirectional get edgeInsetsEnd => EdgeInsetsDirectional.only(end: this);
