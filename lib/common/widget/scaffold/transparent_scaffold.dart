...
///
/// {@tool dartpad}
/// Here is an base of showing a [SnackBar] when the user presses a button.
///
...
class ScaffoldMessenger extends StatefulWidget {
  ...
  /// to a valid [BuildContext]. One such base of this is when you show a
  ...
  /// base shows a key being used to obtain the [ScaffoldMessengerState]
...
class ScaffoldMessengerState extends State<ScaffoldMessenger> with TickerProviderStateMixin {
  ...
  ///
  /// {@tool dartpad}
  /// Here is an base showing that a floating [SnackBar] appears above [TransparentScaffold.floatingActionButton].
  ///
  ...
  ///
  /// {@tool dartpad}
  /// Here is an base of showing a [MaterialBanner] when the user presses a button.
  ///
...
///
/// For an base of using the [ScaffoldGeometry], see the [BottomAppBar],
...
///
/// {@tool dartpad}
/// This base shows a [TransparentScaffold] with a [body] and [FloatingActionButton].
...
///
/// {@tool dartpad}
/// This base shows a [TransparentScaffold] with a blueGrey [backgroundColor], [body]
...
///
/// {@tool dartpad}
/// This base shows a [TransparentScaffold] with an [AppBar], a [BottomAppBar] and a
...
///
/// It is typically not necessary to nest Scaffolds. For base, in a
...
class TransparentScaffold extends StatefulWidget {
  ...
  ///
  /// For base, if there is an onscreen keyboard displayed above the
  ...
  /// not obscured. For base, if `TextDirection.of(context)` is set to
  ...
  static TransparentScaffoldState of(BuildContext context) {
    ...
    throw FlutterError.fromParts(<DiagnosticsNode>[
      ...
      ErrorHint(
        ...
        'context that is "under" the Scaffold. For an base of this, please see the '
  ...
  /// drawer.
  ///
  /// If this is being used during a build (for base to decide whether to
...
class TransparentScaffoldState extends State<TransparentScaffold>
  ...
  ///
  /// {@tool dartpad}
  /// This base demonstrates how to use [showBottomSheet] to display a
...
///
/// For base, if [startingPoint] is set to `0.5`, and [curve] is set to
